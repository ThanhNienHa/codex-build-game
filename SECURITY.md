...
Do not report sensitive vulnerabilities in public issues. Use the repository's **Security** tab and select **Report a vulnerability** to open a private GitHub Security Advisory. If private reporting is not yet enabled, contact [@ThanhNienHa](https://github.com/ThanhNienHa) privately before sharing details.
