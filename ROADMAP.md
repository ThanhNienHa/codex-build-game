...
- Plugin and installable skill packaging
- Deterministic repository validation
- Initial scenario contracts and forward-test procedure
- Contributor, security, and governance documentation
- Optional trusted-maintainer Codex PR review
